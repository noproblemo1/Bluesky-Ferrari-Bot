...
export default class Bot 
{
  ...
  */
  ...
  ) 
  {
    ...
    var bskyFeedAwait = await this.#agent.getAuthorFeed({actor: "notnhl.bsky.social", limit: postNum,}); // Get a defined number + 2 of most recent posts from the logged in user's feed.
